...
interface CustomerPaymentStatusCustomersWithNegativeBalancesPageProps {
  initialCustomerId?: string;
  initialShowDetails?: boolean;
  onNavigate?: (page: string) => void;
}

export const CustomerPaymentStatusCustomersWithNegativeBalancesPage: React.FC<CustomerPaymentStatusCustomersWithNegativeBalancesPageProps> = ({ initialCustomerId, initialShowDetails, onNavigate }) => {
  ...
  // Customers with negative balances data
