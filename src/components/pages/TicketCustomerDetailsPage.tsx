...
import { EditTicketCustomerPage } from './EditTicketCustomerPage';
...
export const TicketCustomerDetailsPage: React.FC<CustomerDetailsPageProps> = ({ 
  ...
  const customerData = {
    ...
    name: '',
    phone: '0244304995',
    identifier: 'S-124', // Stall number for Market, License plate for Lorry Park
    customerType: 'Stall', // Customer Type (Stall, Table-Top, Hawker for Market; Taxi, Trotro, Private for Lorry Park)
    community: 'Adum',
    zone: 'Zone A',
    ticketType: 'Market',
    username: 'TKT-001784',
    ...
    latitude: '5.78441568',
    created: '01 November 2024 2:30 PM',
    createdBy: 'AEDA Admin',
    lastModified: '11 June 2025 9:15 AM',
  ...
  // Rate data - customer's assigned rate based on ticket type, location, and customer type
  const rateData = {
    rateId: 'RATE-006',
    frequency: 'Daily',
    rateType: 'Fixed',
  ...
  // Payment data
  const paymentData = [
    { id: '0525-07-00372-mdslme2v', collector: 'AEDA Admin', type: 'ePayment', date: '01 August 2025 9:08 AM', amount: 165.56, created: '01 August 2025 9:08 AM', status: 'Paid' },
    { id: '0525-07-00372-mcka1wva', collector: 'AEDA Admin', type: 'ePayment', date: '01 July 2025 8:40 AM', amount: 117.08, created: '01 July 2025 8:40 AM', status: 'Paid' },
    { id: '0525-07-00372-mbdikl8o', collector: 'AEDA Admin', type: 'ePayment', date: '01 June 2025 10:24 AM', amount: 141.32, created: '01 June 2025 10:24 AM', status: 'Paid' },
    { id: '0525-07-00372-ma5bw33p', collector: 'AEDA Admin', type: 'ePayment', date: '01 May 2025 12:16 PM', amount: 189.76, created: '01 May 2025 12:16 PM', status: 'Paid' },
    { id: '0525-07-00372-m8ytjkzr', collector: 'AEDA Admin', type: 'ePayment', date: '01 April 2025 6:17 PM', amount: 105.00, created: '01 April 2025 6:17 PM', status: 'Paid' },
    { id: '0525-07-00372-m84agtg3', collector: 'AEDA Admin', type: 'ePayment', date: '11 March 2025 9:29 AM', amount: 189.01, created: '11 March 2025 9:29 AM', status: 'Paid' },
    { id: '019-32LPKD58', collector: 'Rapheal Kwabena Aboagye', type: 'Cash', date: '21 February 2025 11:58 AM', amount: 450.00, created: '21 February 2025 11:58 AM', status: 'Paid' },
    { id: '7ff05772-a9fb-406b-b9a1-ac263dbe0718', collector: 'AEDA Admin', type: 'Cash', date: '30 January 2025 12:00 AM', amount: 297.00, created: '30 January 2025 12:00 AM', status: 'Paid' }
  ];
  ...
  const visitData = [
    { 
      id: '7546', 
      visitDate: '20 August 2025 4:54 PM', 
      staffName: 'Francis Seguri', 
      visitOutcome: 'Other', 
      customerComments: 'next week', 
      staffNotes: '', 
      created: '20 August 2025 4:54 PM', 
      hasGPS: true 
    },
    { 
      id: '2378', 
      visitDate: '21 March 2025 2:32 PM', 
      staffName: 'Francis Seguri', 
      visitOutcome: 'Other', 
      customerComments: 'will pay Monday 24/3/25', 
      staffNotes: '', 
      created: '21 March 2025 2:32 PM', 
      hasGPS: true 
    },
    { 
      id: '1759', 
      visitDate: '13 March 2025 1:10 PM', 
      staffName: 'Francis Seguri', 
      visitOutcome: 'Other', 
      customerComments: '0545357198', 
      staffNotes: '', 
      created: '13 March 2025 1:10 PM', 
      hasGPS: true 
    }
  ];
...
`;
  ...
  // Show EditTicketCustomerPage if showEditCustomer is true
  if (showEditCustomer) {
    return (
      <EditTicketCustomerPage
  ...
  return (
    <div className="p-6 bg-gray-50 h-full overflow-hidden">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Page Title */}
        <div className="mb-4">
          <h1 className="text-2xl font-bold text-gray-900">Ticket Customer Details</h1>
        </div>
            ...
            {activeTab === 'profile' ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-sm font-semibold text-gray-900">{customerData.customerNumber}</p>
                        ...
                        {/* Identifier */}
                        <div>
                          <label className="text-xs font-medium text-gray-500 uppercase tracking-wider block mb-2">Identifier</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{customerData.ticketType}</p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{customerData.location}</p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{customerData.customerType}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 pb-6 border-b border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{customerData.community}</p>
                </div>
            ...
            <div className="mb-6 pb-6 border-b border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                  <span className="text-xs font-medium text-gray-500 uppercase tracking-wider">Total Ticket Transactions</span>
                  <span className="text-sm font-medium text-gray-900">{customerData.totalTicketTransactions}</span>
                </div>
                <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
            ...
            <div>
              ...
              <>
                ...
                <div className="space-y-6">
                  ...
                  {/* Rates Table - Single row for customer's assigned rate */}
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-gray-200">
                          <th className="text-left py-3 px-4 text-sm font-bold text-gray-700">Rate ID</th>
                          ...
                          <th className="text-left py-3 px-4 text-sm font-bold text-gray-700">Unit</th>
                          <th className="text-left py-3 px-4 text-sm font-bold text-gray-700">Status</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="border-b border-gray-100 hover:bg-gray-50">
                          <td className="py-3 px-4 text-sm font-mono text-gray-900">{rateData.rateId}</td>
                          <td className="py-3 px-4 text-sm text-gray-900">{rateData.frequency}</td>
                          <td className="py-3 px-4 text-sm text-gray-900">{rateData.rateType}</td>
                          <td className="py-3 px-4 text-sm font-semibold text-gray-900">GHS {rateData.amount.toFixed(2)}</td>
                          <td className="py-3 px-4 text-sm text-gray-900">{rateData.unit}</td>
                          <td className="py-3 px-4">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                              rateData.status === 'Active' 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <div className="bg-gray-50 rounded-lg p-3">
                      ...
                      <p className="text-sm font-medium text-gray-900">Ticketing</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-3">
                      <label className="text-xs font-medium text-gray-500 uppercase tracking-wider block mb-1">
                        Effective Date
                      </label>
                      <p className="text-sm font-medium text-gray-900">{rateData.effectiveDate}</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-3">
                      <label className="text-xs font-medium text-gray-500 uppercase tracking-wider block mb-1">
                        Expiry Date
                      </label>
                      <p className="text-sm font-medium text-gray-900">{rateData.expiryDate || 'No Expiry'}</p>
                    </div>
                  </div>
                  
                  {/* Last Rate Update Information */}
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-900">
                      <span className="font-semibold">Last Rate Update:</span> {rateData.createdDate}
                      <span className="text-xs text-blue-700 ml-2">
                        (This is when the current rate was assigned to this customer)
                      </span>
                    </p>
                  </div>
                </div>
