...
interface CustomerPaymentStatusVisitedNoPaymentPageProps {
  initialCustomerId?: string;
  initialShowDetails?: boolean;
  onNavigate?: (page: string) => void;
}

export const CustomerPaymentStatusVisitedNoPaymentPage: React.FC<CustomerPaymentStatusVisitedNoPaymentPageProps> = ({ initialCustomerId, initialShowDetails, onNavigate }) => {
