...
interface CustomerPaymentStatusNotVisitedPageProps {
  initialCustomerId?: string;
  initialShowDetails?: boolean;
  onNavigate?: (page: string) => void;
}

export const CustomerPaymentStatusNotVisitedPage: React.FC<CustomerPaymentStatusNotVisitedPageProps> = ({ initialCustomerId, initialShowDetails, onNavigate }) => {
