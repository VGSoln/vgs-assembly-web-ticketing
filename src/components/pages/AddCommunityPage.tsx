...
interface AddCommunityPageProps {
  onSave?: (communityData: any) => void;
  onBack?: () => void;
}

export const AddCommunityPage: React.FC<AddCommunityPageProps> = ({ onSave, onBack }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const newCommunity = {
        ...formData,
        communityId: `COMM-${String(Math.floor(Math.random() * 1000)).padStart(3, '0')}`,
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Create a new community</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-6">
          ...
          {/* Zones (placeholder for future implementation) */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Zones
            </label>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-500">
                Zones can be added after creating the community
              </p>
            </div>
          </div>
        </div>
