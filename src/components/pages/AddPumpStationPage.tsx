...
import { PumpStationReviewPage } from './PumpStationReviewPage';
import { 
...
interface AddPumpStationPageProps {
  onBack?: () => void;
  onSave?: (pumpStationData: PumpStationFormData) => void;
}

export const AddPumpStationPage: React.FC<AddPumpStationPageProps> = ({ onBack, onSave }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform animate-in fade-in-0 zoom-in-95 duration-300">
        ...
        <div className="p-6 text-center">
          <h3 className="text-xl font-semibold text-gray-900 mb-3">
            New Pump Station Successfully Created
          </h3>
          <p className="text-gray-600 mb-6">
            The pump station <strong>{formData.pumpStationName}</strong> has been successfully added to the system.
          </p>
          
          {/* Pump station details summary */}
          <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                <span className="font-medium text-gray-500">Station:</span>
                <p className="text-gray-900">{formData.pumpStationName}</p>
              </div>
              <div>
  ...
  if (showReview) {
    ...
    return (
      <>
        ...
        <PumpStationReviewPage 
          pumpStationData={formData}
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Add New Pump Station</h1>
              <p className="text-sm text-gray-500 mt-1">Fill in the pump station information below</p>
            </div>
          </div>
        </div>
      </div>
