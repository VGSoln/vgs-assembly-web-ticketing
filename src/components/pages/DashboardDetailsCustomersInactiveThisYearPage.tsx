...
interface DashboardDetailsCustomersInactiveThisYearPageProps {
  initialCustomerId?: string;
  initialShowDetails?: boolean;
  onNavigate?: (page: string) => void;
}

export const DashboardDetailsCustomersInactiveThisYearPage: React.FC<DashboardDetailsCustomersInactiveThisYearPageProps> = ({ initialCustomerId, initialShowDetails, onNavigate }) => {
