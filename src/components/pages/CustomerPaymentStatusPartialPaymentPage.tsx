...
interface CustomerPaymentStatusPartialPaymentPageProps {
  initialCustomerId?: string;
  initialShowDetails?: boolean;
  onNavigate?: (page: string) => void;
}

export const CustomerPaymentStatusPartialPaymentPage: React.FC<CustomerPaymentStatusPartialPaymentPageProps> = ({ initialCustomerId, initialShowDetails, onNavigate }) => {
