...
interface MeterReadingLocationModalProps {
  isOpen: boolean;
  onClose: () => void;
  readingId?: string;
  customerName: string;
...
export const MeterReadingLocationModal: React.FC<MeterReadingLocationModalProps> = ({
  isOpen,
  onClose,
  readingId,
  customerName,
  ...
  }, [isOpen, latitude, longitude, customerName, customerNumber, mapType]);
            ...
            <div className="col-span-1">
              <div className="bg-gray-50 rounded-lg p-4 h-[500px] flex flex-col justify-center space-y-5">
                ...
                <div className="pt-3 border-t border-gray-200">
                  ...
                  <p className="text-2xl font-bold text-blue-600">{currentReading.toLocaleString()}</p>
                </div>
              </div>
            </div>
          </div>
