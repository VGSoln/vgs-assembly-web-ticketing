...
interface StorageTankLocationModalProps {
  isOpen: boolean;
  onClose: () => void;
  readingId?: string;
  tankId?: string;
...
export const StorageTankLocationModal: React.FC<StorageTankLocationModalProps> = ({
  isOpen,
  onClose,
  readingId,
  tankId,
          ...
          marker.bindPopup(`
            <div style="padding: 8px; min-width: 200px;">
              ...
              <p style="margin: 0; color: #666; font-size: 12px;">
                Tank: <strong>${tankName}</strong>
              </p>
              <p style="margin: 0; color: #666; font-size: 12px;">
                Tank #: <strong>${tankNumber}</strong>
              </p>
  ...
  }, [isOpen, latitude, longitude, tankName, tankNumber, mapType]);
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[85vh] overflow-hidden">
        ...
        <div className="bg-blue-600 px-5 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-white">Storage Tank Location</h2>
          </div>
          <div className="flex items-center gap-2">
            <button
          ...
          <div className="grid grid-cols-3 gap-5">
            ...
            <div className="col-span-1">
              <div className="bg-gray-50 rounded-lg p-4 h-[500px] flex flex-col justify-center space-y-5">
                ...
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Tank Name</p>
