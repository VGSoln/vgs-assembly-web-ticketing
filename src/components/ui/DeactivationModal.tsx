    ...
    <>
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:w-full" style={{ maxWidth: '522px' }}>
            {/* Header */}
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Footer */}
              <div className="px-6 pt-0.5 pb-2 bg-gray-50 flex justify-end gap-3">
                <button
                  type="button"
                  onClick={handleClose}
