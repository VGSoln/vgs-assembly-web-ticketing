...
export type PageType = 'performance' | 'debt' | 'visits' | 'visits-list' | 'payments' | 'bank-deposits' | 'pump-stations' | 'storage-tanks' | 'pump-station-meter-readings' | 'storage-tank-meter-readings' | 'customer-meter-readings' | 'staff' | 'staff-details' | 'edit-staff' | 'add-staff' | 'customer-locations' | 'collector-locations' | 'collector-paths' | 'pump-station-locations' | 'storage-tank-locations' | 'customers' | 'reactivated-customers' | 'customer-details' | 'dashboard-details-customer-debt' | 'dashboard-details-yearly-water-connections' | 'dashboard-details-paid-customers' | 'dashboard-details-non-paid-customers' | 'dashboard-details-customers-with-no-payments' | 'dashboard-details-inactive-customers' | 'dashboard-details-customers-inactive-this-year' | 'customer-payment-status';